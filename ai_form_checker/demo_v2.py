...
def summarize_promotieplan_overview(text, client):
    prompt = (
        ...
        "Vat dit gedeelte samen in een neutrale samenvatting, waarbij je belangrijke punten benoemt zoals de tijdsduur, "
        "de aanpak, de doelstellingen en andere opvallende elementen. Beperk de samenvatting tot maximaal 200 woorden.\n\n"
        "Tekst:\n" + text
    )
    try:
        response = client.chat.completions.create(
...
def summarize_activiteitenplan_overview(text, client):
    prompt = (
        ...
        "Vat dit gedeelte samen in een neutrale samenvatting, waarbij je belangrijke punten benoemt zoals de planning, "
